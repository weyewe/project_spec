class PaymentPdf < Prawn::Document
  ...
  def title
    bounding_box( [150,cursor], :width => 500) do
      text "Payment: AWESOME", 
          :size => 15, 
          :align => :center 
          
      confirmed_date =  "SEKARANG" #@payment.confirmed_at.in_time_zone(LOCAL_TIME_ZONE)
      text "Date: #{confirmed_date}", 
          :size => 12, 
          :align => :center
    end 
  end
