...
pdf.text "Phase: #{phase.name} [#{phase.code}]", size: 12 , style: :bold

pdf.text "Total PreCondition: #{phase.pre_conditions_count}", size: 12 
pdf.text "Total PostCondition: #{phase.post_conditions_count}", size: 12 
